...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler', './library'],
	...
	RichTextEditor.loadTinyMCE = function(sLocation) {
		if (!RichTextEditor.pLoadTinyMCE) {
			RichTextEditor.pLoadTinyMCE = new Promise(function(fnResolve, fnReject) {
				jQuery.sap.includeScript(sap.ui.resource('sap.ui.richtexteditor', sLocation), "sapui5-tinyMCE", fnResolve, fnReject);
			});
		}
	...
	RichTextEditor.prototype.init = function() {
		...
		if (this.getTooltip_AsString()) {
			this._textAreaDom.setAttribute("title", this.getTooltip_AsString());
		}
	 ...
	 * @private
	 */
	RichTextEditor.prototype._removeEditorTinyMCE4 = function(oEditor) {
		switch (this._tinyMCE4Status) {
			...
			case EditorStatus.Initializing:
				this._pTinyMCE4Initialized.then(this._removeEditorTinyMCE4.bind(this, oEditor));
				break;
