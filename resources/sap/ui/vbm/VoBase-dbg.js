...
sap.ui.define([
	...
	VoBase.prototype.getLabelProps = function(type) {
		...
		oElement.LBC = oElement.LICC = "rgba(255,255,255,1.0)";
		switch (type) {
			case sap.ui.vbm.SemanticType.Error:
				oElement.LICTC = "rgba(255,255,255,1.0)";
				oElement.LBBC = oElement.LICC = this.DefaultColorBad;
				oElement.LIC = "error";
				break;
			case sap.ui.vbm.SemanticType.Warning:
				oElement.LBBC = oElement.LICTC = this.DefaultColorCritical;
				oElement.LIC = "error";
				break;
			case sap.ui.vbm.SemanticType.Success:
				oElement.LBBC = oElement.LICTC = this.DefaultColorGood;
				oElement.LIC = "message-success";
				break;
			case sap.ui.vbm.SemanticType.Inactive:
				oElement.LBBC = oElement.LICTC = this.DefaultColorNeutral;
				oElement.LIC = "message-information";
				break;
			default:
				break;
		}
