...
sap.ui.define([
	...
	Spot.prototype.init = function() {
		...
		this.mProperties.contentColor = (Parameters) ? Parameters.get("sapUiStandardText") : "#000";
	...
	Spot.prototype.getDataElement = function() {
		...
		var oElem = this.getImageProps(this.getType(), txtLen);
		if (oElem.I) {
			oElement.I = oElem.I;
		}
		if (oElem.CO) {
