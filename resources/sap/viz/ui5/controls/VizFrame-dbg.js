...
sap.ui.define([
    ...
    */
     ...
     * @param {Object} [option] the option defines the width and height of exported svg and if the exported svg includes includes the orignal title,legend and title
