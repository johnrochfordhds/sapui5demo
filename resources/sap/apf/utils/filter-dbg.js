...
(function() {
	...
	sap.apf.utils.Filter.createFilterFromSapUi5FilterJSON = function(messageHandler, sapUi5FilterFormat) {
		...
		function addNextLevel(filter, level, format) {
			...
			} else if (format.operator) { //TODO this is an additional check because mapToSapUI5FilterExpression() produces a an empty expression. Fix issue in mapToSapUI5FilterExpression()
