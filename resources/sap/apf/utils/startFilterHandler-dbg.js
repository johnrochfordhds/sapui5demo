 ...
 * @param {function} inject.functions.getCombinedContext {@link sap.apf.utils.ExternalContext#getCombinedContext} 
			...
			getStartFilters().forEach(function(startFilter) {
				if (startFilter.getPropertyName() === propertyName) {
					if(internalFilter.isDisjunctionOverEqualities()){
						startFilter.setSelectedValues(getListFromFilter(internalFilter));
					} else {
