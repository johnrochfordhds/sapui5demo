...
* @param {position}
*/
sap.suite.ui.commons.ProcessFlowLaneHeader.prototype._setMergedPosition = function (nPos) {
  this._mergedLanePosition = nPos;
};
 ...
 * @returns {Number} nGaps number of gaps
 * @since 1.22
 */
  ...
  if (oStatuses) {
    ...
    for (var j in oStatuses) {
      if (oStatuses[j].value != 0) {
        ...
        sAriaText = sAriaText.concat(valueText);
      }
    }
