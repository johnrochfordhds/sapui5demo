...
sap.suite.ui.commons.ProcessFlowNodeRenderer.assignNodeClasses = function (oRm, oControl, nodeLevel) { // EXC_SAP_006_1, EXC_JSHINT_047
  ...
  if (nodeLevel === 0) {
    ...
    if (oControl.getType() === sap.suite.ui.commons.ProcessFlowNodeType.Aggregated) {
      sap.suite.ui.commons.ProcessFlowNodeRenderer.assignAggregatedNodeClasses(oRm, oControl);
    }
  }
 ...
 * @param {sap.ui.core.Control} oControl an object representation of the control that should be rendered
 */
sap.suite.ui.commons.ProcessFlowNodeRenderer.assignAggregatedNodeClasses = function (oRm, oControl) {
  switch (oControl._getDisplayState()) {
 ...
 */
sap.suite.ui.commons.ProcessFlowNodeRenderer.assignShadowClasses = function (oRm, oControl, sBorder) {
